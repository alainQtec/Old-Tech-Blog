(function ($) {
  var aiMsg = ["👋 ", "Welcome to my personnal site 😊", "I'm always interested in new stuff.", "Have a new project? Let's talk.", "I am a developer, designer and content creator.", "Follow @alainQtec 🙃", "Visit my tech blog 😉"];
